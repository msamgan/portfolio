        ...
        <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-4 py-16">
          ...
          <div className="lg:col-span-2 space-y-6">
            <a href="/" className="inline-block group">
              <span className="text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 via-violet-400 to-cyan-300 group-hover:from-violet-400 group-hover:via-cyan-300 group-hover:to-violet-400 transition-all duration-500">
                {data.username}
              </span>
            </a>
              ...
              <form onSubmit={handleSubscribe} className="flex gap-2">
                <div className="relative flex-1 max-w-sm">
                  <input
                    ...
                    className="w-full px-4 py-2.5 rounded-lg bg-white/5 border border-white/10 text-white placeholder:text-white/40 focus:outline-none focus:ring-2 focus:ring-cyan-500/50 focus:border-cyan-500/50 transition-all"
                    disabled={subscribed}
                  />
                  {subscribed && (
                    <div className="absolute inset-0 flex items-center justify-center bg-emerald-500/20 backdrop-blur-sm rounded-lg border border-emerald-500/50">
                ...
                <button
                  type="submit"
                  disabled={subscribed}
                  className="px-5 py-2.5 rounded-lg bg-gradient-to-r from-cyan-500 to-violet-500 text-white font-medium hover:shadow-lg hover:shadow-cyan-500/30 transition-all duration-300 hover:scale-105 active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100"
                >
                  Subscribe
                </button>
              </form>
          ...
          <div className="space-y-4">
            ...
            <nav className="flex flex-col gap-3">
              {[
                ...
                >
                  <span className="w-0 h-px bg-gradient-to-r from-cyan-400 to-violet-400 group-hover:w-4 transition-all duration-300" />
