        ...
        <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-4 py-16">
          ...
          <div className="lg:col-span-2 space-y-6">
            <a href="/" className="inline-block group">
              <span className="text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-cyan-300 group-hover:from-violet-400 group-hover:via-cyan-300 group-hover:to-violet-400 transition-all duration-500">
                {data.username}
              </span>
            </a>
            <p className="text-white/70 text-base leading-relaxed max-w-md">
              Software Engineer specializing in scalable, high-performance
              solutions. Passionate about building exceptional digital
