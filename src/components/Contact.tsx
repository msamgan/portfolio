            ...
            <div className="text-center space-y-8 py-8">
              ...
              <div className="relative py-8">
                ...
                <div className="relative flex justify-center">
                  <span className="px-4 bg-[var(--color-surface)] text-sm text-white/50">Or connect via social media</span>
                </div>
              </div>
              ...
              <div className="flex flex-wrap items-center justify-center gap-4">
                ...
                {socials.twitter && (
                  ...
                  >
                    ...
                    <span className="text-sm font-medium text-white/80 group-hover:text-white transition-colors">Twitter</span>
                  </a>
                )}
                {socials.youtube && (
                  <a
                  ...
                  >
                    ...
                    <span className="text-sm font-medium text-white/80 group-hover:text-white transition-colors">YouTube</span>
                  </a>
                )}
              </div>
            </div>
