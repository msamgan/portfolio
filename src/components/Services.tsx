          ...
          >
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-2 pt-2">
                ...
                <span className="text-xs text-cyan-400 opacity-0 group-hover:opacity-100 transition-all duration-300 transform translate-x-2 group-hover:translate-x-0">
                  Learn more
                </span>
                <svg className="w-4 h-4 text-cyan-400 opacity-0 group-hover:opacity-100 transition-all duration-300 transform translate-x-2 group-hover:translate-x-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
