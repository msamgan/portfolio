            ...
            <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
                {data.services.map((s, index) => (
                    ...
                    >
                        ...
                        <div
                            className="relative aspect-video w-full rounded-xl overflow-hidden mb-5 bg-gradient-to-br from-cyan-500/10 via-violet-500/10 to-emerald-500/10">
                            {localImages[s.img] ? (
                                <img
                        ...
                        <div className="space-y-4">
                            <div className="flex items-start justify-between gap-3">
                                <div className="flex items-center gap-3">
                                    <div
                                        className="p-2 rounded-lg bg-gradient-to-br from-cyan-500/20 to-violet-500/20 text-cyan-300 border border-cyan-500/30">
                                        {serviceIcons[s.name]}
                                    </div>
                        ...
                        <div
                            ...
                            <div
                                className="absolute inset-0 rounded-2xl bg-gradient-to-r from-cyan-500 via-violet-500 to-emerald-500 opacity-20 blur-xl"/>
                        </div>
                    </div>
                ))}
            </div>
