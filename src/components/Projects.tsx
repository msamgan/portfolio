...
const getProjectCategory = (name: string): string => {
  ...
  if (nameLower.includes('extension') || nameLower.includes('vscode') || nameLower.includes('pint')) return 'extension'
  if (nameLower.includes('shortener') || nameLower.includes('ms0')) return 'tool'
  if (nameLower.includes('laravel') || nameLower.includes('checker') || nameLower.includes('lact')) return 'package'
  return 'default'
}
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between pt-2">
                  <div className="flex items-center gap-2">
                    ...
                    <svg className="w-3 h-3 text-cyan-400 opacity-0 group-hover:opacity-100 transition-all duration-300 transform translate-x-2 group-hover:translate-x-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  {p.repo && (
                    ...
                    >
                      <svg className="w-4 h-4 text-white/50 group-hover/repo:text-cyan-400 transition-colors" fill="currentColor" viewBox="0 0 24 24">
      ...
      <div className="mt-16 text-center space-y-6 animate-fade-in-up">
        <div className="max-w-2xl mx-auto">
          ...
          <p className="text-[var(--color-muted)] mb-6">
            I'm always working on something new. Let's connect and discuss how we can collaborate.
          </p>
        </div>
