...
function Toast({message, show, onClose}: { message: string; show: boolean; onClose: () => void }) {
    ...
    return (
        <div className="fixed bottom-24 right-8 z-50 animate-fade-in-up">
            <div
                className="card bg-gradient-to-r from-cyan-500/20 to-violet-500/20 border-2 border-cyan-500/50 backdrop-blur-xl shadow-2xl">
                <div className="flex items-center gap-3">
                    <div
                        className="w-10 h-10 rounded-full bg-gradient-to-r from-cyan-500 to-violet-500 flex items-center justify-center flex-shrink-0">
    ...
    return (
        <>
            <div className="mt-16 pt-8 border-t border-white/10">
                <div
                    className="card bg-gradient-to-br from-cyan-500/5 via-violet-500/5 to-emerald-500/5 border border-white/10 relative overflow-hidden">
                    ...
                    <div className="flex items-center gap-3 mb-6">
                        <div
                            className="w-12 h-12 rounded-xl bg-gradient-to-r from-cyan-500 to-violet-500 flex items-center justify-center flex-shrink-0">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-[var(--color-muted)] mt-1">Spread the knowledge with your
                                network</p>
                        </div>
                    </div>
                    ...
                    {/* Additional info */}
                    <div
                        className="mt-6 pt-6 border-t border-white/10 flex items-center gap-2 text-sm text-[var(--color-muted)]">
...
export default function PostPage({slug}: PostPageProps) {
    ...
    return (
        <div className="min-h-screen bg-[var(--color-bg)] text-white relative overflow-hidden">
            ...
            <div
                className="absolute top-20 right-10 w-72 h-72 bg-cyan-500/10 rounded-full blur-3xl animate-pulse pointer-events-none"/>
            <div
            ...
            <div className="absolute inset-0 pointer-events-none opacity-20">
                <svg className="absolute top-32 right-1/4 w-24 h-24 animate-float" style={{animationDuration: '6s'}}
                     viewBox="0 0 100 100">
                ...
                <svg className="absolute top-1/3 left-16 w-20 h-20 animate-float"
                    ...
                    <div className="max-w-4xl mx-auto">
                            ...
                            <div className="animate-fade-in-up">
                                <div className="card border-2 border-red-500/30 bg-red-500/5">
                                    <div className="flex items-start gap-4">
                                        <div
                                            className="flex-shrink-0 w-12 h-12 rounded-full bg-red-500/10 flex items-center justify-center">
                                        ...
                                        <div className="flex-1">
                                            <h3 className="text-xl font-semibold text-red-200 mb-2">Error Loading
                                                Post</h3>
                        ...
                        {!loading && !error && post && (
                            ...
                            #{name}
                                    ...
                                    {/* Meta information */}
                                    <div
                                        className="flex flex-wrap items-center gap-4 text-sm text-[var(--color-muted)]">
                                        {post.author && (
                                            <div className="flex items-center gap-2">
                                                <div
                                                    className="w-10 h-10 rounded-full bg-gradient-to-r from-cyan-500 to-violet-500 flex items-center justify-center font-bold text-white">
                                ...
                                {post.featured_image && (
                                    <div
                                        className="mb-12 relative rounded-2xl overflow-hidden ring-1 ring-white/10 hover:ring-white/20 transition-all">
                                        <img
                                            src={post.featured_image}
                                    ...
                                    <div className="mt-12 pt-8 border-t border-white/10">
                                        ...
                                        <div className="flex flex-wrap gap-2">
                                            {post.tags.map((t, idx) => {
                                                ...
                                                return (
                                                    <span key={idx}
                                                          className="badge hover:bg-gradient-to-r hover:from-cyan-500/10 hover:to-violet-500/10">
                            #{name}
                          </span>
                                                )
                                            })}
                            ...
                            <div className="animate-fade-in-up">
                                <div className="card text-center py-16">
                                    ...
                                    <p className="text-[var(--color-muted)] mb-8">
                                        We couldn't find a post with the slug "<span
                                        className="text-cyan-400">{slug}</span>".
                                    </p>
                                    <button
                                        onClick={() => window.history.back()}
