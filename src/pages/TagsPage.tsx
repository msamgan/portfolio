...
export default function TagsPage() {
    ...
    const normalizeTags = (raw: any): (TagItem | string)[] => {
        ...
        for (const item of mapped) {
            const key = typeof item === 'string' ? item.toLowerCase() : (item.slug || item.name || '').toLowerCase()
            ...
            <section
                ...
                <div className="relative text-center max-w-4xl mx-auto space-y-6 animate-fade-in-up">
                    ...
                    <p className="text-lg md:text-xl text-[var(--color-muted)] max-w-2xl mx-auto leading-relaxed">
                        Discover content organized by topics. Filter and explore articles, projects, and resources across various technologies and themes.
                    </p>
                    ...
                    {!loading && !error && (
                        <div className="grid grid-cols-3 gap-6 max-w-2xl mx-auto pt-8">
                            <div className="space-y-2 animate-fade-in-up" style={{animationDelay: '0.2s'}}>
                                ...
                                <div className="text-sm text-[var(--color-muted)]">Total Tags</div>
                            </div>
                            <div className="space-y-2 animate-fade-in-up" style={{animationDelay: '0.3s'}}>
                                <div className="text-3xl md:text-4xl font-bold gradient-text">
                                    {Array.isArray(tags) ? tags.reduce((sum, t) => sum + (renderTagCount(t) ?? 0), 0) : 0}+
                                </div>
                                <div className="text-sm text-[var(--color-muted)]">Tagged Items</div>
                            </div>
                            <div className="space-y-2 animate-fade-in-up" style={{animationDelay: '0.4s'}}>
                                <div className="text-3xl md:text-4xl font-bold gradient-text">100%</div>
                                <div className="text-sm text-[var(--color-muted)]">Categorized</div>
                            </div>
                        </div>
                    )}
                </div>
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="card p-6 space-y-4">
                                <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center justify-between">
                                    <h2 className="text-2xl font-semibold gradient-text">All Tags</h2>
                                ...
                                <div className="flex flex-col sm:flex-row gap-4">
                                    ...
                                    <div className="relative flex-1">
                                        <svg className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-[var(--color-muted)]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}
                                    ...
                                    <div className="relative">
                                        ...
                                        <svg className="absolute right-3 top-1/2 -translate-y-1/2 w-5 h-5 text-[var(--color-muted)] pointer-events-none" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        ...
                                        return (
                                            ...
                                            >
                                                ...
                                                <div className="flex items-center gap-2 flex-1 min-w-0">
                                                    {/* Tag icon */}
                                                    <svg className="w-4 h-4 text-cyan-400 flex-shrink-0 group-hover:scale-110 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}
                                                              d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z"/>
                                                    </svg>
            ...
            <section className="relative py-20 px-6 overflow-hidden">
                ...
                <div className="relative max-w-4xl mx-auto text-center space-y-8">
                    ...
                    <p className="text-lg text-[var(--color-muted)] max-w-2xl mx-auto">
                        Explore my blog posts, projects, and resources. Each piece is carefully tagged to help you find exactly what you need.
                    </p>
