        ...
        async function load() {
            ...
            try {
                ...
                const list = Array.isArray(json)
                    ? json
                    : (json.data ?? json.items ?? json.posts ?? []);
                setPosts(Array.isArray(list) ? list : []);
            } catch (e: unknown) {
                if ((e as any)?.name !== 'AbortError') {
                    setError(
                        (e as Error)?.message || 'Something went wrong while loading tag posts.'
                    );
                }
            } finally {
                setLoading(false);
                ...
                <section className="relative min-h-[40vh] flex items-center justify-center pt-24 pb-16 px-6 overflow-hidden">
                    ...
                    <div className="relative text-center max-w-4xl mx-auto space-y-6 animate-fade-in-up">
                        ...
                        <p className="text-lg md:text-xl text-[var(--color-muted)] max-w-2xl mx-auto leading-relaxed">
                            Explore all articles and content tagged with{' '}
            ...
            <section className="relative py-20 px-6 overflow-hidden">
                ...
                <div className="relative max-w-4xl mx-auto text-center space-y-8">
                    ...
                    <p className="text-lg text-[var(--color-muted)] max-w-2xl mx-auto">
                        Browse all blog posts or explore other tags to find more articles on topics
                        that interest you.
                    </p>
